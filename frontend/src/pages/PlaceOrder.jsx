...
import CardTotal from '../componnents/CardTotal'
...
const PlaceOrder = () => {
  ...
  return (
    <div className='flex flex-col sm:flex-row justify-between gap-4 pt-5 sm:pt-14 min-h-[80] boredr-t '>
        {/* lest side */}
      ...
      <div className="mt-8">
        ...
        <div className="mt-12">
            ...
            <div className="flex gap-3 flex-col lg:flex-row ">
               ...
               <div onClick={()=>setMethod("rezorpay")} className="flex items-center gap-3 border p-2 cursor-pointer">
